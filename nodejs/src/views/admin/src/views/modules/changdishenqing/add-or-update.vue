<template>
	<div class="addEdit-block" :style='{"padding":"30px","backgroundAttachment":"fixed","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20230312/52c1bcab43064c72aa492e0f342d2666.jpg)","flexDirection":"row-reverse","display":"flex","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","height":"calc(100vh - 120px)"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="场地名称" prop="changdimingcheng">
					<el-input v-model="ruleForm.changdimingcheng" placeholder="场地名称" clearable  :readonly="ro.changdimingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="场地名称" prop="changdimingcheng">
					<el-input v-model="ruleForm.changdimingcheng" placeholder="场地名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="场地位置" prop="changdiweizhi">
					<el-input v-model="ruleForm.changdiweizhi" placeholder="场地位置" clearable  :readonly="ro.changdiweizhi"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="场地位置" prop="changdiweizhi">
					<el-input v-model="ruleForm.changdiweizhi" placeholder="场地位置" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="容纳人数" prop="rongnarenshu">
					<el-input v-model="ruleForm.rongnarenshu" placeholder="容纳人数" clearable  :readonly="ro.rongnarenshu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="容纳人数" prop="rongnarenshu">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="申请说明" prop="shenqingshuoming">
					<el-input v-model="ruleForm.shenqingshuoming" placeholder="申请说明" clearable  :readonly="ro.shenqingshuoming"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="申请说明" prop="shenqingshuoming">
					<el-input v-model="ruleForm.shenqingshuoming" placeholder="申请说明" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="社长姓名" prop="shezhangxingming">
					<el-input v-model="ruleForm.shezhangxingming" placeholder="社长姓名" clearable  :readonly="ro.shezhangxingming"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="社长姓名" prop="shezhangxingming">
					<el-input v-model="ruleForm.shezhangxingming" placeholder="社长姓名" readonly></el-input>
				</el-form-item>
			</template>
		...
		init(id,type) {
			...
			this.$http({
				...
				if (data && data.code === 0) {
					...
					if(((json.shezhangxingming!=''&&json.shezhangxingming) || json.shezhangxingming==0) && this.$storage.get("role")!="管理员"){
						this.ruleForm.shezhangxingming = json.shezhangxingming
						this.ro.shezhangxingming = true;
					}
				} else {
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `changdishenqing/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.changdishenqingCrossAddOrUpdateFlag = false;
						 this.parent.search();
