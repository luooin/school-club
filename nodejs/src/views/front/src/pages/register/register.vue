<template>
	...
	<div class="container" :style='{"minHeight":"100vh","alignItems":"center","backgroundImage":"url(http://codegen.caihongy.cn/20221024/23b37078fa41495b866fda764fd3ea28.png)","display":"flex","width":"100%","backgroundSize":"100% 100%","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
		<el-form class='rgs-form' v-if="pageFlag=='register'" :style='{"width":"750px","padding":"20px","margin":"40px 0","borderRadius":"10px","background":"#fff","height":"auto"}' ref="registerForm" :model="registerForm" :rules="rules">
			...
			<div v-if="true" :style='{"width":"100%","margin":"20px 0 20px 0","lineHeight":"44px","fontSize":"36px","color":"#000","textAlign":"center"}'>校园社团平台注册</p></div>
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='xuesheng'" prop="xuehao">
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='xuesheng'" prop="mima">
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='xuesheng'" prop="xingming">
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='xuesheng'" prop="xingbie">
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='xuesheng'" prop="shouji">
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='xuesheng'" prop="touxiang">
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='shezhang'" prop="shezhangzhanghao">
				<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}'>社长账号：</div>
				<el-input v-model="registerForm.shezhangzhanghao"  placeholder="请输入社长账号" />
			</el-form-item>
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='shezhang'" prop="mima">
				<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}'>密码：</div>
				<el-input v-model="registerForm.mima" type="password" placeholder="请输入密码" />
			</el-form-item>
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='shezhang'" prop="mima">
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='shezhang'" prop="shezhangxingming">
				<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}'>社长姓名：</div>
				<el-input v-model="registerForm.shezhangxingming"  placeholder="请输入社长姓名" />
			</el-form-item>
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='shezhang'" prop="xingbie">
				<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}'>性别：</div>
                <el-select v-model="registerForm.xingbie" placeholder="请选择性别" >
                  <el-option
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='shezhang'" prop="lianxidianhua">
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='shezhang'" prop="touxiang">
				<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}'>头像：</div>
                <file-upload
					tip="点击上传头像"
					action="file/upload"
...
export default {
    ...
    created() {
      ...
      if ('shezhang' == this.tableName) {
        this.rules.shezhangxingming = [{ required: true, message: '请输入社长姓名', trigger: 'blur' }];
      }
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            var url=this.tableName+"/register";
               ...
               if(`shezhang` == this.tableName && this.registerForm.mima!=this.registerForm.mima2) {
                this.$message.error(`两次密码输入不一致`);
                return
               }
